    ...
    <>
      ...
      <CardContainer>
        ...
        <ModalContainerBody>
          ...
          />
          <RowModalContainer>
            {playerStatistics[0].player.firstname}
          </RowModalContainer>
          <RowModalContainer>
            {playerStatistics[0].player.lastname}
          </RowModalContainer>
          <RowModalContainer>
            {playerStatistics[0].player.age}
          </RowModalContainer>
          <RowModalContainer>
            {playerStatistics[0].player.nationality}
          </RowModalContainer>
          <RowModalContainer>
            {playerStatistics[0].player.height}
          </RowModalContainer>
          <RowModalContainer>
            {playerStatistics[0].player.weight}
          </RowModalContainer>
          <RowModalContainer>
            {playerStatistics[0].player.injured}
          </RowModalContainer>
        </ModalContainerBody>
        <ButtonSiteContainer>
          <LinkModal
